...
public class ScriptableObjectrCustomEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        foreach (var method in type.GetMethods(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance))
        {
            ...
            if (attributes.Length > 0)
            {
                ...
                ButtonAttribute attribute = attributes[0] as ButtonAttribute;
                GUI.enabled = (! Application.isPlaying && attribute.Editor) || Application.isPlaying;
